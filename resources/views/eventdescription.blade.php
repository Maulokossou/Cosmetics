    ...
    <div class="container my-24 mx-auto md:px-6 xl:px-32">
        ...
        <div class="mb-12 grid items-center gap-x-6 md:grid-cols-2 xl:gap-x-12">
            <div class="mb-6 md:mb-0">
                <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat dark:shadow-black/20"
        ...
        <div class="grid-cols-1 sm:grid md:grid-cols-3 p-6">
            <div
                class="block w-full max-w-[18rem] border border-primary-one p-2 rounded-lg bg-white text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white">
                <ul class="w-full">
                    <li
                        class="w-full border-neutral-100 text-3xl font-bold text-center text-primary-one 100 border-opacity-100 px-4 py-3  dark:border-white/10">
                        Packet <br> VIP
                    </li>
                    <li class="w-full border-neutral-100 text-center border-opacity-100 px-4 py-3  dark:border-white/10">
                    ...
                    <li
                        class="w-full text-primary-one font-bold border-neutral-100 text-center  border-opacity-100 px-4 py-3  dark:border-white/10">
                        30.000
                    </li>
                </ul>
                <div
                    class="rounded-lg flex justify-center items-center border-neutral-100 text-center bg-zinc-50 p-4 dark:border-white/10 dark:bg-neutral-700">
