...
<header class="z-10 py-4 bg-white shadow-md ">
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-main">
        <!-- Mobile hamburger -->
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative">
                <button class="align-middle rounded-full  focus:outline-none"
                    ...
                    aria-haspopup="true">
                    <img  src="https://ui-avatars.com/api/?background=random&name={{ $user->fullname }}" class="object-cover w-8 h-8 rounded-full" alt="User Image" />
                </button>
