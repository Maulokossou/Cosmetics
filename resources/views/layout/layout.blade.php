...
<body>
    ...
    <nav class="relative flex w-full flex-nowrap items-center justify-between bg-zinc-50 py-8 shadow-dark-mild dark:bg-neutral-700 lg:flex-wrap lg:justify-start lg:py-4"
        data-twe-navbar-ref>
        <div class="flex w-full flex-wrap items-center justify-between px-3">
            <div class="ms-2 h-14 w-40">
                <a class="text-xl text-black dark:text-white h-full w-full" href="/">
            ...
            <div class="!visible mt-2 hidden flex-grow basis-[100%] items-center lg:mt-0 lg:!flex lg:basis-auto"
                ...
                <ul class="list-style-none ms-auto flex flex-col ps-0 lg:mt-1 lg:flex-row" data-twe-navbar-nav-ref>
                    ...
                    <li class="my-4 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
                        <a class="text-black dark:text-white lg:px-2" aria-current="page" href="{{ route("index") }}"
                            data-twe-nav-link-ref>Accueil</a>
                    </li>
                    <!-- Features link -->
                    <li class="mb-4 ps-2 lg:mb-0 lg:pe-1 lg:ps-0" data-twe-nav-item-ref>
                        <a class="p-0 text-black transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2"
                            href="{{ route('service') }}" data-twe-nav-link-ref>Nos Services</a>
                    </li>
                    {{-- <li class="mb-4 ps-2 lg:mb-0 lg:pe-1 lg:ps-0" data-twe-nav-item-ref>
                        <a class="p-0 text-black transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2"
                    ...
                    <li class="mb-4 ps-2 lg:mb-0 lg:pe-1 lg:ps-0" data-twe-nav-item-ref>
                        <a class="p-0 text-black transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2"
                            href="{{ route('event') }}" data-twe-nav-link-ref>Évènements</a>
                    </li>
                    <!-- Pricing link -->
                    <li class="mb-4 ps-2 lg:mb-0 lg:pe-1 lg:ps-0" data-twe-nav-item-ref>
                        <a class="p-0 text-black transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2"
                            href="{{ route('contact') }}" data-twe-nav-link-ref>Contact</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!-- Footer container -->
    <footer
        class="flex flex-col items-center text-white bg-primary-two text-center dark:bg-neutral-700 dark:text-white lg:text-left">
